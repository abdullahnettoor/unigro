...
**Title**
Consistent Responsive UI System + PWA App-Shell Feel for UniGro
...
- `Button` adds standardized size tokens and optional `density` for compact controls. File: `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/Button.tsx`.
- New `Surface` component consolidates `Card` + `GlassSurface` behavior. Existing components become wrappers or are migrated. Files: `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/Card.tsx`, `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/GlassSurface.tsx`.
- New `PageShell` component standardizes layout width, padding, and header spacing. File: `/Users/abdullahnettoor/Projects/UniGro/src/components/layout/PageShell.tsx`.
- New `AppShell` layout for PWA feel (header + nav + safe-area). File: `/Users/abdullahnettoor/Projects/UniGro/src/components/layout/AppShell.tsx`.
...
1. **Semantic token layer in `index.css`.**
   ...
   - File: `/Users/abdullahnettoor/Projects/UniGro/src/index.css`.
...
2. **Consolidate surfaces into `Surface`.**
   ...
   - Files: `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/Surface.tsx` (new), `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/Card.tsx`, `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/GlassSurface.tsx`.
...
3. **Normalize control sizes and radii.**
   ...
   - Files: `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/Input.tsx`, `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/Select.tsx`, `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/Textarea.tsx`, `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/SegmentedControl.tsx`, `/Users/abdullahnettoor/Projects/UniGro/src/components/ui/Button.tsx`.
...
4. **Introduce `PageShell` layout rhythm.**
   ...
   - Files: `/Users/abdullahnettoor/Projects/UniGro/src/components/layout/PageShell.tsx`, `/Users/abdullahnettoor/Projects/UniGro/src/pages/Dashboard.tsx`, `/Users/abdullahnettoor/Projects/UniGro/src/pages/Pots.tsx`.
...
5. **PWA AppShell polish (mobile-first).**
   ...
   - Files: `/Users/abdullahnettoor/Projects/UniGro/src/components/layout/AppShell.tsx`, `/Users/abdullahnettoor/Projects/UniGro/src/App.tsx`.
...
7. **Alternate theme (parallel aesthetic).**
   ...
   - Files: `/Users/abdullahnettoor/Projects/UniGro/src/index.css`, `/Users/abdullahnettoor/Projects/UniGro/src/App.tsx`.
