...
export function ModalShell({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "glass-3 border border-[var(--border-subtle)] rounded-t-2xl sm:rounded-2xl w-full max-h-[88vh] flex flex-col overflow-hidden relative animate-in fade-in zoom-in duration-200",
          sizeClass[size],
          className
        )}
      >
