...
export function DetailHeader({ title, isOrganizer, organizer, onShare, onEdit, onJoin }: DetailHeaderProps) {
    ...
    return (
        <header className="sticky top-0 z-50 w-full glass-sticky border-b border-[var(--border-subtle)]/30 px-4 py-3 pb-3 flex items-center justify-between gap-3 shadow-sm safe-top">
